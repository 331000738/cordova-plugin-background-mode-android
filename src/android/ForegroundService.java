...
public class ForegroundService extends Service {
    ...
    private Notification makeNotification (JSONObject settings)
    {
        ...
        String CHANNEL_ID = "cordova-plugin-background-mode-android-id";
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            // The user-visible name of the channel.
            CharSequence name = settings.optString("channelName", "cordova-plugin-background-mode-android");
            // The user-visible description of the channel.
            String description = settings.optString("channelDescription", "cordova-plugin-background-mode-androidn notification");
